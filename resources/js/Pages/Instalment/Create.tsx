...
const InstalmentCreate = ({
    ...
    const validateForm = (): boolean => {
        ...
        // Validate each direct_instalment_payments item if provided
        if (
            data.direct_instalment_payments &&
                        ...
                        data?.direct_instalment_payments?.length > 0 ? (
                            data.direct_instalment_payments.map(
                                (payment, index) => (
                                    <div
                                        key={index}
                                        className="grid grid-cols-1 md:grid-cols-7 gap-4 mb-2"
                                    >
                                        <div className="flex flex-col w-full md:col-span-3">
                                            <label className="text-base mb-1 after:content-['*'] after:text-red-500 after:ml-1">
                                                Nominal Pembayaran (Angsuran ke-
                                                {index + 1})
                                            </label>
                                            <Input
                                                type="number"
                                        ...
                                        <div className="flex flex-col w-full md:col-span-3">
                                            <label className="text-base mb-1 after:content-['*'] after:text-red-500 after:ml-1">
                                                Tanggal Pembayaran (Angsuran ke-
                                                {index + 1})
                                            </label>
                                            <DatePickerInput
...
export default InstalmentCreate;
