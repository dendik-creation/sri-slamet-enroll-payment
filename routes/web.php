...
Route::middleware("auth")->group(function () {
    ...
    // Print Instalment
    Route::get("/instalment/print-legger", [
        InstalmentController::class,
        "printLegger",
    ]);
    Route::get("/instalment/{instalment_id}/print", [
        InstalmentController::class,
        "print",
    ]);
    ...
    Route::prefix("salary-slip")->group(function () {
        ...
        Route::get("/show/{salary_id}", [
            EmployeeSalaryController::class,
            "slipShow",
        ]);
        Route::get("/edit/{salary_id}", [
            EmployeeSalaryController::class,
            "slipEdit",
        ]);
        Route::put("/update/{salary_id}", [
            EmployeeSalaryController::class,
            "slipUpdate",
        ]);
        Route::get("/print/all", [
        ...
        Route::get("/print/spesific/{salary_id}", [
            EmployeeSalaryController::class,
            "printSalarySlipSpesific",
        ]);
        Route::delete("/{salary_id}", [
            EmployeeSalaryController::class,
            "slipDestroy",
        ]);
    });
    ...
    Route::prefix("thr")->group(function () {
        ...
        Route::get("/{thr_bonus_id}/print-legger", [
            ThrController::class,
            "printLegger",
        ]);
        Route::get("/{thr_bonus_id}/print-all", [
            ThrController::class,
            "printAll",
        ]);
        Route::get("/{thr_bonus_id}/print/{employee_thr_id}", [
            ThrController::class,
            "printSpesific",
        ]);
    });
    ...
    Route::prefix("backup")->group(function () {
        ...
        Route::delete("/delete/{file_name}", [
            GlobalSettingController::class,
            "deleteBackup",
        ]);
        Route::put("/restore/{file_name}", [
            GlobalSettingController::class,
            "restoreBackup",
        ]);
    });
    ...
    Route::get("/salary-deduction/{salary_deduction_id}/print", [
        SalaryDeductionController::class,
        "print",
    ]);
});
